            ...
            <section class="container-fluid mt-40 cara w-4/5 mx-auto">
                ...
                <div class="flex items-center justify-evenly pb-10">
                    <div class="text-xl basis-8/12 p-5">
                        ...
                        <p class="indent-8 text-justify leading-8">Selain itu gaya belajar ini bisa menyusun sesuatu hal dengan secara terorganisir seperti bermain puzzle, dan hal-hal yang berbau logika lainnya.</p>
                    </div>
